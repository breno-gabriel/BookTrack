...
4. Em outro terminal, dirija-se novamente a pasta ***service*** e execute o comando `npm run migrate`. Em seguida, execute o comando `npm run start:dev` para iniciar o servidor
