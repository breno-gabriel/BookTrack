import { getAllUsersService, getUserByIdService, deleteUserByIdService } from "../services/userService";
...
export { getAllUsersController, getUserByIdController, deleteUserByIdController };
